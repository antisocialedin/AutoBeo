...
for ip in ip_list:
    ...
    try:
        ...
        echo "192.168.40.1:/home/cluster/clusterdir /home/cluster/clusterdir nfs rw,async,hard,int 0 0" | sudo -S tee /tmp/fstab.temp &&
        mv /tmp/fstab.temp /etc/fstab &&
        # Monta o diretório NFS
        sudo -S mount -t nfs 192.168.40.1:/home/cluster/clusterdir /home/cluster/clusterdir
        """
